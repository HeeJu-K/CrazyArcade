 ...
 *
 */
public class BubbleMode extends SuperElement{
	...
	//构造函数
	public BubbleMode(int x, int y, int w, int h, ImageIcon img, int imgW, int imgH, int playerNum,int power) {
		super(x, y, w, h);
		this.img = img;
	...
	//创建气泡
	public static BubbleMode createBubbleMode(int x, int y,List<String> list,int playerNum,int power) {
		//list=[Bubble,w,h]
		...
		return new BubbleMode(x, y, w, h, imageMap.get(list.get(0)), imgW, imgH ,playerNum, power);
	}
